...
class BaseProduct:
    ...
    def init_operations(self):
        ...
        # all_sco_operations = self._mdib.descriptions.parent_handle.get(self._sco.sco_descriptor_container.Handle, [])
        all_sco_operation_entities = self._mdib.entities.parent_handle.get(self._sco.sco_descriptor_container.Handle, [])
    ...
    def make_operation_instance(self,
        ...
        operation_target_entity = self._mdib.entities.handle.get_one(operation_target_handle,
    ...
    def _register_existing_mdib_operations(self, sco: AbstractScoOperationsRegistry):
        operation_entities = self._mdib.entities.parent_handle.get(
            self._sco.sco_descriptor_container.Handle, [])
        for entity in operation_entities:
            ...
            if registered_op is None:
                ...
                operation = self.make_operation_instance(entity.descriptor, sco.operation_cls_getter)
                if operation is not None:
                    sco.register_operation(operation)
