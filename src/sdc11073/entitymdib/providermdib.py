...
TransactionFactory = Callable[[mdibbase.EntityMdibBase, TransactionType, LoggerAdapter],
                              AnyTransactionManagerProtocol]


class EntityProviderMdib(mdibbase.EntityMdibBase):
    ...
    table_cls = mdibbase.EntityLookupProvider
